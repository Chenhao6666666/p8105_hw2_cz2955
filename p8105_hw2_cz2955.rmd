...
There are a total of `r nrow(z_together)` observations, comprising `r n_distinct(z_together$ZipCode)` distinct zipcodes and `r n_distinct(z_together$Neighborhood)` different neighbourhoods.
